        ...
        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 grid-margin">
          <div className="d-flex align-items-center justify-content-between mb-2">
            ...
            <div className="action">
              <button className="btn btn-light btn-rounded btn-md text-small text-uppercase">
                View all
              </button>
            </div>
          </div>
              ...
              {upEvents.map((event, i) => (
                <div className="col-md-6">
                  <div className="card">
                    ...
                    <div className="event-dueDate-div d-flex align-items-start">
                      <img
                        src={require("../../assets/images/icons/calendar.svg")}
                        alt="calendar icon"
                      />
                      <div style={{ textAlign: "left" }}>
                        <div className="event-dueDate">{event.dueDate}</div>
                        <div>Due date</div>
                      </div>
                    </div>
